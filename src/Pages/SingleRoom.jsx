...
const SingleRoom = () => {
  ...
  useEffect(() => {
    fetch(`https://hotel-booking-api-eta.vercel.app/rooms/${id}`)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        setRoomInfo(data[0]);
  ...
  // const [roomInfo, setRoomInfo] = useState(null);
  useEffect(() => {
    fetch("https://hotel-booking-api-eta.vercel.app/rooms")
      .then((res) => res.json())
      .then((data) => {
        // console.log(data);
        setRooms(data);
  ...
  useEffect(() => {
    fetch("https://hotel-booking-api-eta.vercel.app/blogs")
      .then((res) => res.json())
      .then((data) => {
        setBlogs(data);
      });

...
const Rooms = () => {
  ...
  useEffect(() => {
    fetch("https://hotel-booking-server-nine-peach.vercel.app/roomsCount")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch(
      `https://hotel-booking-server-nine-peach.vercel.app/rooms?page=${currentPage}&size=${itemsPerPage}`
    )
      .then((res) => res.json())
      .then((data) => {
        // console.log(data);
